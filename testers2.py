...
def read_all_files():
    import os
    replicas = []
    files = os.listdir("/home/varsha/Documents/final_results/Krongen/planar/Boeing/")
    for file in files:
        tmp = nx.read_gml("/home/varsha/Documents/final_results/Krongen/planar/Boeing/"+file)
